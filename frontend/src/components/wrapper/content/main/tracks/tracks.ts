...
export class Tracks extends AbstractComponent {
	...
	getTemplate() {
      ...
      data-target="tracks"
      >
        <h2 class="tracks__h2 title__h2" id="title">Треки</h2>
        <div class="tracks__content">
          ...
          <ul class="tracks__list" id="tracksList"></ul>
        </div>
      </section>
    `;
	}
	...
	removeElement() {
		this.element = document.querySelector(".tracks") ?? null;
